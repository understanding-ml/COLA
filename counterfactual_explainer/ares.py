...
from xai_cola.data_interface.base_data import BaseData
...
class ARecourseS(CounterFactualExplainer):  # need the feature tree
    ...
    def generate_counterfactuals(
        ...
        df_counterfactual = pd.DataFrame(ares.R.cfx_matrix[0], columns=self.x_factual_pandas.columns)
...
class AReS:
    ...
    def evaluate_groundset(
        self, lams, r=None, save_mode=0, disable_tqdm=False, plot_accuracy=False
    ):
...
class TwoLevelRecourseSet:
    ...
    def evaluate_triples(
        self, ares, r=None, save_mode=0, disable_tqdm=False, plot_accuracy=False
    ):
        """
